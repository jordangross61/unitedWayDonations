 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Jordan");
		  toPrint += p1.toString("jgross41");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Virginia");
		  toPrint += p2.toString("vfishburn3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Kate Schaffer");
		  toPrint += p3.toString("kschaffer7");
<<<<<<< HEAD
...
=======
          ...
          toPrint += p6.toString("kpatel465");
>>>>>>> 0b10ba6df40aced402d5ec8b19a11dcb32f8caf4
